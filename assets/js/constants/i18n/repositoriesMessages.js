    ...
    'languages': {
        'en': {
            ...
            'repository1-description2': 'UNCode is an online platform - developed on ' +
                                        ...
                                        '- to practice programming exercises and perform automatic grading ' +
                                        'of code made by the students to help them in their learning processes.',
            'repository1-description3': 'UNCode is actually used by the Universidad Nacional de Colombia, ' +
                                        'Bogotá headquarters, to evaluate the written code by the students in multiple programming ' +
                                        'languages as C / C ++, Java and Python 3; also, the UNCode judge can be used in hardware ' +
                                        'description languages such as VHDL and Verilog, or with Jupyter Notebooks tasks. ' +
                                        'For this reason, UNCode has been used in different university courses as: ' +
                                        'basic computer programming, data structures, machine learning, programming languages, ' +
                                        'quantum programming, etc.',
            'repository1-description4': 'UNCode have a backend that handles the interaction with Docker and ' +
                                        'the grader, and a frontend where the students can upload their codes in a simple and ' +
                                        'pleasant interface. Also, the frontend includes an administrator interface to allows ' +
                                        'teachers and tutors check their students progress and modify the tasks on a simple way.',
            ...
            'repository1-description6': 'Another interesting feature of UNCode is that it can be used as an external grader for ' +
                                        'Learning Management Systems (LMS), as Moodle or OpenEDX.',
            ...
            'repository4-description1': 'Python tutor is a tool that helps the students to pass one of ' +
                                        ...
                                        'is happening in each code line. This tool allows the student to visualize step by step, ' +
                                        'the code behavior in the different languages such as Python, Java, JavaScript, ' +
                                        'TypeScript, Ruby, C or C++ in web browsers.',
            'repository4-description2': 'Some modifications to the original code were made in this repository, ' +
                                        ...
                                        'the UNCode interface, and then allows users to visualize code on Python 3, Java, C and C++. ',
            ...
            'repository8-description2': 'The repository code was developed using <em>Docker stored</em> on Doker Hub: ' +
                                        ...
                                        'which is at the same time used by a Linux service called <em>cokap</em>. ',
        ...
        'es': {
            ...
            'repository4-description1': 'Python Tutor es una herramienta que ayuda a superar una de las mayores barreras en el ' +
                                        ...
                                        'de código escrito en Python, Java, JavaScript, TypeScript, Ruby, C o C++ en navegadores web.',
            'repository4-description2': 'En el repositorio se hicieron algunas modificaciones al código original con el propósito ' +
                                        ...
                                        'C/C++ y Java. ',
            'repository4-description3': '>El proyecto de Python tutor fue creada por <a href="https://pg.ucsd.edu/" target="_blank">Philip Guo</a>' +
            ...
            'repository7-description1': 'En este repositorio se puede encontrar diferentes pruebas para aplicar a UNCode.',
            ...
            'repository8-description2': 'El código del repositorio fue desarrollado usando <em>Docker stored</em> en Doker Hub: ' +
                                        '<a href="https://hub.docker.com/r/unjudge/opt-cpp-backend" target="_blank">unjudge/opt-cpp-backend</a>, ' +
                                        'que al mismo tiempo es usado por un servicio de Linux llamado <em>cokap</em>. ',
